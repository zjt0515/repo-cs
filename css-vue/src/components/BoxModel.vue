<template>
  <div>
    <div class="wrapper">
      <div class="box" :style="boxStyle">盒子模型</div>
    ...
    <button type="button" @click="toggleBoxSizing" class="btn btn-light">切换{{ isBorderBox ? 'border-box' : 'content-box'
      }}</button>
...
const boxOffsetWidth = computed(() => isBorderBox.value ? boxWidth.value : boxWidth.value + boxPadding.value + boxBorderWidth.value)
